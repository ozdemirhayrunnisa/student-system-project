function addStudent(event) {
    ...
    fetch('https://localhost:7007/Student/students', {
        method: 'POST',
...
document.getElementById('submit_student').addEventListener("click", function(e) {
    addStudent(e);
 });
...
window.onload = function() {
    ...
    if(userRole === "Admin"){
        document.getElementById('homepage').href = '/admin-dashboard.html';
