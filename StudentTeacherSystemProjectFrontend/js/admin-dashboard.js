function loadStudents() {
    fetch('https://localhost:7007/Student')
...
function loadCourses() {
        fetch('https://localhost:7007/api/Course')
            .then(response => response.json())
            .then(courses => {
        ...
        function loadTeacher() {
            fetch('https://localhost:7007/Instructor')
                .then(response => response.json())
                .then(teachers => {
                    const teacherContainer = document.getElementById('all_teacher');
                    ...
                    const headers = ['Ad', 'Soyad', 'Email', 'Departman'];
                    headers.forEach(headerText => {
                        const th = document.createElement('th');
                        th.textContent = headerText;
                        th.style.padding = '8px'; // Optional padding for a cleaner look
                    ...
                    teachers.forEach(teacher => {
                       ...
                       // Create table cells for each property
                const nameCell = document.createElement('td');
                nameCell.textContent = teacher.first_Name || '';
                nameCell.style.padding = '8px';
                row.appendChild(nameCell);

                const surnameCell = document.createElement('td');
                surnameCell.textContent = teacher.last_Name || '';
                surnameCell.style.padding = '8px';
                row.appendChild(surnameCell);
